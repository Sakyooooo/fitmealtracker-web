...
const ACCENT = '#AB47BC'; // フレンド専用カラー（パープル）
      ...
      <div className="flex flex-col" style={{ minHeight }}>
        ...
        <div className="flex-1 flex flex-col items-center justify-center px-6 text-center">
          ...
          <div className="bg-gray-50 rounded-2xl px-5 py-4 text-left w-full max-w-sm mb-6 space-y-2">
            <p className="text-xs text-gray-600"><span className="font-bold">① DBテーブル未作成</span><br /><span className="text-gray-400">001_friends.sql を実行してください</span></p>
            <div className="h-px bg-gray-200" />
            <p className="text-xs text-gray-600"><span className="font-bold">② プロジェクトが一時停止中</span><br /><span className="text-gray-400">Supabase ダッシュボードで再起動</span></p>
            <div className="h-px bg-gray-200" />
